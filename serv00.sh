...
echo "$vl_link" >> jh.txt
vmws_link="vmess://$(echo "{ \"v\": \"2\", \"ps\": \"$NAME-vmess-ws\", \"add\": \"$IP\", \"port\": \"$vmess_port\", \"id\": \"$UUID\", \"aid\": \"0\", \"scy\": \"auto\", \"net\": \"ws\", \"type\": \"none\", \"host\": \"\", \"path\": \"/\", \"tls\": \"\", \"sni\": \"\", \"alpn\": \"\", \"fp\": \"\"}" | base64 -w0)"
echo "$vmws_link" >> jh.txt
vmatls_link="vmess://$(echo "{ \"v\": \"2\", \"ps\": \"$NAME-vmess-ws-tls-argo\", \"add\": \"icook.hk\", \"port\": \"8443\", \"id\": \"$UUID\", \"aid\": \"0\", \"scy\": \"auto\", \"net\": \"ws\", \"type\": \"none\", \"host\": \"$argodomain\", \"path\": \"/\", \"tls\": \"tls\", \"sni\": \"$argodomain\", \"alpn\": \"\", \"fp\": \"\"}" | base64 -w0)"
echo "$vmatls_link" >> jh.txt
vma_link="vmess://$(echo "{ \"v\": \"2\", \"ps\": \"$NAME-vmess-ws-argo\", \"add\": \"icook.hk\", \"port\": \"8880\", \"id\": \"$UUID\", \"aid\": \"0\", \"scy\": \"auto\", \"net\": \"ws\", \"type\": \"none\", \"host\": \"$argodomain\", \"path\": \"/\", \"tls\": \"\"}" | base64 -w0)"
...
servkeep() {
#green "开始安装Cron进程保活"
curl -sSL https://raw.githubusercontent.com/kwzzz03/sing-box-yg/main/serv00keep.sh -o serv00keep.sh && chmod +x serv00keep.sh
...
curl -sL https://raw.githubusercontent.com/kwzzz03/sing-box-yg/main/app.js -o "$keep_path"/app.js
...
if [[ -e $WORKDIR/config.json ]]; then
  ...
  mkdir -p "$HOME/bin"
  curl -Ls https://raw.githubusercontent.com/kwzzz03/sing-box-yg/main/serv00.sh > "$SCRIPT_PATH"
  chmod +x "$SCRIPT_PATH"
...
#curl -sSL https://raw.githubusercontent.com/kwzzz03/sing-box-yg/main/serv00.sh -o serv00.sh && chmod +x serv00.sh
   echo -e "========================================================="
